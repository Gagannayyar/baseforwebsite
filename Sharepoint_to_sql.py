...
Created By: nayyar.31@apac.teleperformance.com
Date: 3rd March 2022
Version: 1.0.0
Updated on: --/--/----
"""
...
USERNAME = 'yourname@organisation.com' #Sharpoint user name[NEEDS TO BE CHNAGED]
PASSWORD = 'Password' #sharepoint password[NEEDS TO BE CHNAGED]
SHAREPOINT_URL = 'https://organisation.sharepoint.com' #sharepoint url
SHAREPOINT_SITE = 'https://organisation.sharepoint.com/sites/mysite' #Sharepoint Site[NEEDS TO BE CHNAGED]
SHAREPOINT_DOC = 'Shared Documents'
FOLDER = 'FolderName' #Folder name from where the data is required[NEEDS TO BE CHNAGED]
UPLOAD_FOLDER = 'Updated FolderName' #Folder to move the uploaded file[NEEDS TO BE CHNAGED]
#Varibles required for the script
#SQL Server name
server_name = "server_name"#[NEEDS TO BE CHNAGED]
#Database Name
database_name = "database_name" #[NEEDS TO BE CHNAGED]
#Folder from where we have to import files
#folder = r"C:\Users\Folder"
#[NEEDS TO BE CHNAGED]
insert_query = """INSERT INTO SchemaName.table_name (
Id,
Column1,
Column2
)
...
def import_files_to_sql_local(files_list, server_name, database_name, Driver='{SQL Server Native Client 11.0}'):
    ...
    if files_list != []:
        ...
        for i in files_list:
            ...
            #df['ReferrerURL'] = " " #this is custom. Please remove for your files
...
def import_files_to_sql_sharepoint(files_list, server_name, database_name,  Driver='{SQL Server Native Client 11.0}'):
    ...
    """
    try:
        connection_string = f"Driver={{ODBC Driver 17 for SQL Server}};Server={server_name};Database={database_name};UID={USERNAME};PWD={PASSWORD};authentication=ActiveDirectoryPassword"
...
def script_logs(script_name, file_names):
    ...
    insert_query= "INSERT INTO qa_transformation.script_logs(script_name, run_date, message, file_names) VALUES (?,?,?,?)"
...
script_logs("Comments to SQL", files_list)
